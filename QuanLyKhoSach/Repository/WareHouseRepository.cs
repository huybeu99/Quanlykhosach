...
namespace QuanLyKhoSach.Repository
{
    public class WareHouseRepository : IWareHouseRepository
    {
        ...
        {
            var warehouse= await _context.WareHouses.SingleOrDefaultAsync(w => w.WareHouse_ID==id);
        ...
        {
            return await _context.WareHouses.FirstOrDefaultAsync(w => w.WareHouse_ID == id);
        }

        public async Task<WareHouse> UpdateWareHouseAsync(WareHouse warehouse)
        {
            var ExittingWareHouse = await _context.WareHouses.FirstOrDefaultAsync(w => w.WareHouse_ID == warehouse.WareHouse_ID);
